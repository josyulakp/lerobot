...
class FeetechMotorsBus:
    ...
    def get_comm_result(self, result):
        """Get the communication result message from the protocol packet handler.
        
        Args:
            result (int): The communication result code from the protocol packet handler
            
        Returns:
            str: A descriptive message about the communication result
        """
        if self.mock:
            import tests.motors.mock_scservo_sdk as scs
        else:
        ...
        return self.packet_handler.getTxRxResult(result)

    def get_rx_packet_error(self, error):
        """Get the error message from the received packet.
        
        Args:
            error (int): The error code from the received packet
        ...
        return self.packet_handler.getRxPacketError(error)
